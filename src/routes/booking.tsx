      ...
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="bg-white rounded-[2.5rem] p-10 shadow-[0_20px_50px_-20px_rgba(0,0,0,0.05)] border border-gray-100">
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full bg-[#25D366] hover:bg-[#128C7E] text-white font-medium py-3.5 rounded-xl transition-colors shadow-lg shadow-[#25D366]/20 flex items-center justify-center gap-2"
            >

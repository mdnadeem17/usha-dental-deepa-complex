...
file_path = "/Users/mohammednadeem/Downloads/usha-dental-deepa-complex-main/src/routes/index.tsx"

with open(file_path, "r") as f:
    content = f.read()

start_marker = "              {/* Luxury Tabs Selector */}"
end_marker = "                    {/* Secondary Tray: Floating Glassmorphism Pills (Only visible in 'All' tab) */}"
...
replacement = """              {/* Luxury Tabs Selector (Apple Segmented Control Style) */}
